var StudentModule = (function () {
    ...
    return {
        ...
        addStudent: function (student, callback) {
            ...
            xhttp.open("POST", "http://nathancooper-contosouniversity.azurewebsites.net/api/Students", true);
            xhttp.setRequestHeader("Content-type", "application/json");
        ...
        updateStudent: function (studentid, student, callback) {
            ...
            xhttp.open("PUT", "http://nathancooper-contosouniversity.azurewebsites.net/api/Students/" + studentid, true);
            xhttp.setRequestHeader("Content-type", "application/json");
        ...
        deleteStudent: function (studentid, callback) {
            ...
            xhttp.open("DELETE", "http://nathancooper-contosouniversity.azurewebsites.net/api/Students/" + studentid, true);
            xhttp.setRequestHeader("Content-type", "application/json");
